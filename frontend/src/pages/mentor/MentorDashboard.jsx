  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <h1 className="text-2xl md:text-3xl font2 font-bold mb-4">............Good Things Come from Good Things</h1>
        <h1 className="text-2xl md:text-3xl font2 font-bold mb-4">Welcome, <span className='text-purple-500 font2'>Mentor!</span></h1>
        <div className="bg-black p-4 md:p-6 rounded-lg shadow-md mb-6">
